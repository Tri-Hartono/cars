...
import { MessageCircle, MapPin, Phone, Clock, ShieldCheck } from "lucide-react";
    ...
    <footer className="bg-white text-neutral-600 pt-16 pb-12 border-t border-neutral-200/90 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-12 border-b border-neutral-200">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <p className="text-xs sm:text-sm text-neutral-600 leading-relaxed max-w-sm">
              <strong className="text-neutral-900 font-semibold">AutoValu</strong> adalah platform pembelian mobil bekas langsung tanpa perantara di wilayah Jabodetabek. Proses cepat, inspeksi gratis ke rumah, dan pembayaran tunai cair dalam 15 menit.
            </p>
            <div className="pt-1">
              <a
                href={waUrl}
              ...
              >
                ...
                <span>WhatsApp: +62 812-3420-8253</span>
              </a>
            </div>
          </div>
            ...
            <div className="space-y-2.5 text-xs text-neutral-700">
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-neutral-600 mt-0.5">+62 812-3420-8253</p>
                </div>
              </div>
        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-neutral-500">
          <p>© {new Date().getFullYear()} AutoValu Indonesia. All rights reserved.</p>
