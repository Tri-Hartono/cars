...
import { MessageCircle, MapPin, Phone, Clock, ShieldCheck, ExternalLink, Link2 } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-12 border-b border-neutral-200">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <div className="pt-1 flex flex-wrap items-center gap-2">
              <a
                ...
                aria-label="WhatsApp"
                className="w-8 h-8 rounded-lg bg-emerald-50 hover:bg-emerald-600 text-emerald-700 hover:text-white border border-emerald-200 flex items-center justify-center transition-all"
              >
              ...
              <a
                ...
                className="w-8 h-8 rounded-lg bg-pink-50 hover:bg-pink-600 text-pink-700 hover:text-white border border-pink-200 flex items-center justify-center transition-all"
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="Facebook"
                className="w-8 h-8 rounded-lg bg-blue-50 hover:bg-blue-600 text-blue-700 hover:text-white border border-blue-200 flex items-center justify-center transition-all"
              >
              ...
              <a
                ...
                className="w-8 h-8 rounded-lg bg-neutral-100 hover:bg-neutral-900 text-neutral-700 hover:text-white border border-neutral-200 flex items-center justify-center transition-all"
              >
              ...
              <Link
                ...
                className="inline-flex items-center gap-1 text-[11px] font-bold bg-neutral-100 hover:bg-neutral-200 text-neutral-800 px-2.5 py-1.5 rounded-lg border border-neutral-200 transition-all ml-1"
              >
          ...
          <div className="lg:col-span-2 space-y-3">
            ...
            <ul className="space-y-2 text-xs sm:text-sm">
              ...
              <li>
                <Link href="/links" className="text-emerald-700 font-bold hover:underline">
                  Semua Tautan (Bio)
                </Link>
              </li>
            </ul>
